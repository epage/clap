...
_FEATURES_default =
_FEATURES_wasm = --features "yaml regex unstable-replace unstable-multicall"
_FEATURES_full = --features "yaml regex unstable-replace unstable-multicall wrap_help"
